...
export const settingsAuthTab2faSelector = '[data-action="settings-auth-tab-totp"]'
...
export const settingsAuth2faSetupCardSelector = '[data-action="settings-auth-totp-setup-card"]'
export const settingsAuth2faManageCardSelector = '[data-action="settings-auth-totp-manage-card"]'
export const settingsAuth2faManageDisabledReasonSelector = '[data-action="settings-auth-totp-manage-disabled-reason"]'
...
export const settingsAuthenticationMenu2faSelector = '[data-action="settings-authentication-menu-totp"]'
