...
export const settingsAuthTabTotpSelector = '[data-action="settings-auth-tab-totp"]'
...
export const settingsAuthTotpSetupCardSelector = '[data-action="settings-auth-totp-setup-card"]'
export const settingsAuthTotpManageCardSelector = '[data-action="settings-auth-totp-manage-card"]'
export const settingsAuthTotpManageDisabledReasonSelector = '[data-action="settings-auth-totp-manage-disabled-reason"]'
...
export const settingsAuthenticationMenuTotpSelector = '[data-action="settings-authentication-menu-totp"]'
