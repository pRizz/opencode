...
export function SettingsAuthTwoFactorTab() {
  ...
  return (
    <div class="flex h-full flex-col overflow-y-auto no-scrollbar px-4 pb-10 sm:px-10 sm:pb-10" data-action="settings-auth-2fa-content">
      ...
      <div class="flex flex-col gap-4">
        ...
        <Tooltip placement="top" value={manageDisabledReason()} inactive={!manageDisabled()}>
          <div
            ...
            data-action="settings-auth-2fa-manage-card"
          >
            <Show
              when={!manageDisabled()}
              fallback={
                <div class="text-13-regular text-text-weak" data-action="settings-auth-2fa-manage-disabled-reason">
