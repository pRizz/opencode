...
export namespace Flag {
  ...
  export const OPENCODE_ENABLE_TOTP_RESET = truthy("OPENCODE_ENABLE_TOTP_RESET") || truthy("OPENCODE_ENABLE_2FA_RESET")
  /** @deprecated Use OPENCODE_ENABLE_TOTP_RESET. */
  export const OPENCODE_ENABLE_2FA_RESET = OPENCODE_ENABLE_TOTP_RESET
...
// This must be evaluated at access time, not module load time,
// because test and tooling environments can update this env var at runtime
