...
plan: 07
subsystem: auth
tags: [totp, qrcode, setup-wizard]

dependency-graph:
  requires: [10-01, 10-02, 10-04, 10-05]
  provides: [totp-setup, qr-generation, totp-wizard]
  affects: []
...
# Phase 10 Plan 07: TOTP Setup Wizard Summary
...
- Warning banner if user already has TOTP configured
...
6. On next login, user will be prompted for TOTP code
...
| 9f3aa19b6 | feat  | Add TOTP setup wizard endpoints and page         |
...
The flow integrates with existing TOTP verification from Plan 10-05/10-06.
